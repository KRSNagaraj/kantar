...
namespace KantarBotService.AzureSearch
{
    public static class SearchHelper
    {
        ...
        public static DocumentSearchResult<Assets> search(string keyword)
        {
            _keyword = keyword;
            ...
            return RunQueries(indexClientForQueries);
            //return "";
        }
        ...
        private static DocumentSearchResult<Assets> RunQueries(ISearchIndexClient indexClient)
        {
            ...
            results = indexClient.Documents.Search<Assets>(_keyword, parameters);
